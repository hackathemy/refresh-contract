...
task(
  "add-project",
  `Add a sample project on our protocol contract in polygon mumbai`,
...
The account currently has ${balanceInEth} ${
  ...
  const tx = await receiver.createProject("test_uri", "Swift Energy", "POWER");

  console.log(`\n__Deployed Contract__
  Reciver contract is deployed to ${network.name} at ${receiver.address}
